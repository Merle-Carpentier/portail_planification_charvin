...
//import ReactAgendaCtrlctrl from '../../Components/ReactAgendaCtrl/ReactAgendaCtrlctrl'
...
export default function Bookingg(props) {
    ...
    const [rowsPerHour, setRowsPerHour] = useState(2)       //nombre de cellule par heure (récupération dans le store customersi utilisateur=user)
    ...
    useEffect(() => {
        ...
        //console.log('reactAgendaCtrl', ReactAgendaCtrlctrl)
